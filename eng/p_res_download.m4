m4_divert(-1)
m4_define(`__TITLE',`Products/Resor/Download')
			  			...
			  			<tr>
							...
							<td valign="top"><!-- Contents -->
								__SECTION_STYLE_BEG("600",<b>Download</b>)
									Here you can <b>soon</b> get the most recent version.
							    It's version __VERSION_Resor from __RELDATE_Resor. <br>
									Please remember that this is only a first preview.
								__SECTION_STYLE_END
								__SECTION_SPACER
										...
										<td bgcolor="#FFFFFF">
											<table border="0" cols="4" bgcolor="#EEF7FF" cellspacing="1" cellpadding="2">
												...
												<tr>
													...
													<td><a href="__REMOTE_BINARIES/resor.lzx">resor.lzx</a></td>
													<td><a href="__REMOTE_BINARIES/resor.zip">resor.zip</a></td>
													<td><!--a href="__AMINET_BINARIES/mus/misc/resor.lha"-->resor.lha<!--/a--></td>
													<td>user archive</td>
												</tr>
											</table>
										</td>
