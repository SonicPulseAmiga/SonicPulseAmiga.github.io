m4_divert(-1)
m4_define(`__TITLE',`Products/FractalUniverse/Screenshots')
			  		...
			  		<tr>
							...
							<td valign="top"><!-- Contents -->
								__SECTION_STYLE_BEG("600",<b>Screenshots</b>)
									Nachfolgend können sie sich einige Screenshots von FractalUniverse anschauen, um einen Eindruck zu bekommen wie es aussieht.
									Sie sind von der Version 1.66. Klicken sie die Bilder an um grössere Versionen zu sehen.
									<center>
