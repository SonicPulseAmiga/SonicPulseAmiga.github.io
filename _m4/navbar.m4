m4_define(`__NAVBUTTON_NEWS',`m4_ifelse(`$1',`News',
	`<a href="news.html"     ><img src="../img/news1.gif" border="0" name="btnNews" alt="News" width="100" height="20"></a>',
	`<a href="news.html"     onMouseOver="imgChange(7,btnNews1)" onMouseOut="imgChange(7,btnNews0)"><img src="../img/news0.gif" border="0" name="btnNews" alt="News" width="100" height="20"></a>')m4_dnl
')m4_dnl
m4_define(`__NAVBUTTON_PRODUCT',`m4_ifelse(`$1',`Product',
	`<a href="products.html" ><img src="../img/products1.gif" border="0" name="btnProd" alt="Products" width="100" height="20"></a>',
	`<a href="products.html" onMouseOver="imgChange(8,btnProd1)" onMouseOut="imgChange(8,btnProd0)"><img src="../img/products0.gif" border="0" name="btnProd" alt="Products" width="100" height="20"></a>')m4_dnl
')m4_dnl
m4_define(`__NAVBUTTON_ABOUT',`m4_ifelse(`$1',`About',
	`<a href="about.html"    ><img src="../img/about1.gif" border="0" name="btnAbou" alt="About" width="100" height="20"></a>',
	`<a href="about.html"    onMouseOver="imgChange(9,btnAbou1)" onMouseOut="imgChange(9,btnAbou0)"><img src="../img/about0.gif" border="0" name="btnAbou" alt="About" width="100" height="20"></a>')m4_dnl
')m4_dnl
